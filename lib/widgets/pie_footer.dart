...
//         color: _pieBlue,
//         border: Border(
//           top: BorderSide(color: Color(0x33FDB515), width: 1),
//         ),
//       ),
//       padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 28),
//       child: LayoutBuilder(
...
//           // Mobile vertical padding reduced
//           final mobileVPadding = 12.0;
//           final verticalPadding = isWide ? 28.0 : mobileVPadding;
...
//                         crossAxisAlignment: CrossAxisAlignment.start,
//                         children: [
//                           const Expanded(flex: 3, child: _FooterBrandSection()),
//                           const SizedBox(width: 32),
//                           Expanded(
//                             flex: 2,
//                             child: _FooterProgramsSection(onProgramTap: onProgramTap),
//                           ),
//                           const SizedBox(width: 32),
//                           Expanded(
//                             flex: 2,
...
//                           // Mobile: Programs + Company side-by-side
//                           Row(
//                             crossAxisAlignment: CrossAxisAlignment.start,
//                             children: [
//                               Expanded(
...
//                           // Contact below
//                           _FooterContactSection(onEmailTap: onEmailTap, onPhoneTap: onPhoneTap),
//                         ],
//                       ),
//               ),
//             ),
...
//           const SizedBox(height: 12),
//           Text(
//             '© PieStudy ${DateTime.now().year}. All rights reserved.',
//             style: const TextStyle(
//               fontFamily: 'Inter',
//               fontSize: 11.5,
//               color: Color(0xFF9CA3AF),
...
//       title: 'Programs',
//       children: items
//           .map((e) => _FooterLink(label: e.$1, onTap: () => onProgramTap?.call(e.$2)))
//           .toList(),
//     );
//   }
// }
...
//       title: 'Company',
//       children: [
//         _FooterPlainText('About Us', onTap: onAboutTap),
//         _FooterPlainText('Our Verticals', onTap: onVerticalsTap),
//         _FooterPlainText('Terms & Conditions', onTap: onBlogTap),
//         _FooterLink(label: 'FAQ', onTap: onFaqTap),
//       ],
//     );
//   }
// }
...
//   const _FooterContactSection({this.onEmailTap, this.onPhoneTap});
...
//         _FooterContactRow(icon: Icons.email_outlined, text: 'connect@piestudy.com', onTap: onEmailTap),
//         const SizedBox(height: 6),
//         _FooterContactRow(icon: Icons.phone_outlined, text: '+91-XXXXXXXXXX', onTap: onPhoneTap),
//       ],
//     );
//   }
// }
...
//   const _FooterContactRow({required this.icon, required this.text, this.onTap});

//   @override
//   Widget build(BuildContext context) {
//     final row = Row(
//       children: [
//         Icon(icon, size: 16, color: _pieGold),
//         const SizedBox(width: 8),
//         Flexible(
//           child: Text(
//             text,
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           Text(title, style: const TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.w700, fontSize: 14, color: Colors.white)),
//           const SizedBox(height: 8),
//           ...children,
//         ],
//       ),
...
//     if (onTap == null) {
//       return Padding(padding: const EdgeInsets.only(bottom: 6), child: text);
//     }

//     return InkWell(
//       onTap: onTap,
//       borderRadius: BorderRadius.circular(4),
//       child: Padding(padding: const EdgeInsets.only(bottom: 6, top: 2), child: text),
//     );
//   }
// }
