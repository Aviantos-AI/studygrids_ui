...
class _StatusBadge extends StatelessWidget {
  ...
  // New optional parameters for colors
  final Color? bgColor;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        // Use custom bgColor if provided, otherwise default white opacity
      ...
      child: Row(
        ...
        children: [
          Icon(
            icon, 
            size: 14, 
            // Use custom iconColor if provided, otherwise default orange
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: FontWeight.w800,
              fontSize: 11.5,
              // Use custom textColor if provided, otherwise default brown
...
/**---Data Science  */
// ✅ NEW DATA SCIENCE HERO CARD
// ✅ FINAL PREMIUM DATA SCIENCE BANNER (Shimmer + Pulse)
// ✅ DEEP NAVY PREMIUM CARD FOR SLIDER
class _DataScienceHeroCard extends StatelessWidget {
  const _DataScienceHeroCard();
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _BannerChipLight(label: 'Real-world Projects'),
                            ],
                          ),
                        ],
                      ),
...
class _BannerChipLight extends StatelessWidget {
  final String label;
  const _BannerChipLight({required this.label});
...
// ✅ LEFT SIDE SMALL TILE (Shimmer + Pulse)
class _DataScienceSmallTile extends StatefulWidget {
  const _DataScienceSmallTile();

  @override
  State<_DataScienceSmallTile> createState() => _DataScienceSmallTileState();
}

class _DataScienceSmallTileState extends State<_DataScienceSmallTile>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      constraints: const BoxConstraints(maxWidth: 380), // Limited width
      child: Material(
        color: Colors.transparent,
        child: InkWell(
          onTap: () {
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.auto_graph_rounded, color: Color(0xFFFACC15), size: 24),
                    ),
                    ...
                    return Positioned.fill(
                      child: FractionallySizedBox(
                        ...
                        alignment: AlignmentGeometry.lerp(
                          Alignment.centerLeft - const Alignment(2.0, 0),
                          Alignment.centerRight + const Alignment(2.0, 0),
                          _controller.value,
                        )!,
                        child: Container(
                          decoration: BoxDecoration(
