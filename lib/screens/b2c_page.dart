...
//       endDrawer: Drawer(
//         child: PieNavDrawer(
//           activeId: 'b2c', // agar nav me item nahi hai to null kar dena
//           onItemTap: (id) {
...
//   Widget build(BuildContext context) {
//     return Container(
//       width: double.infinity, // full-width gradient
...
//                 Text(
//                   'Learn AI, ML and Data skills with mentor-led cohorts, real projects and job-focused curriculum designed for Indian learners.',
//                   textAlign:
//                       isMobile ? TextAlign.left : TextAlign.center,
//                   softWrap: true,
//                   style: const TextStyle(
...
//         description:
//             'Get resume review, LinkedIn optimisation and mock interviews.',
//       ),
//       _JourneyStep(
//         number: 5,
...
//                         SizedBox(height: 6),
//                         Text(
//                           'Join the next cohort and get personalised guidance, projects and mock interviews with PieStudy mentors.',
//                           style: TextStyle(
//                             fontFamily: 'Inter',
//                             fontSize: 13.5,
//                             height: 1.5,
...
// const Color _pieBlue = Color(0xFF0B3558); // Pie (blue)
// const Color _pieGold = Color(0xFFFDB515); // Study (gold)
...
//       endDrawer: Drawer(
//         child: PieNavDrawer(
//           activeId: 'b2c', // agar nav me nahi hai to null kar sakte ho
//           onItemTap: (id) {
//             Navigator.pop(context);
//             handlePieNavTap(context, id);
//           },
...
//           colors: [
//             _pieBlue,
//             Color(0xFF102947), // slightly darker blue bottom
//           ],
//           begin: Alignment.topCenter,
//           end: Alignment.bottomCenter,
//         ),
...
// /// ---------------- HIGHLIGHT CTA SECTION (BLUE + GOLD) ----------------
...
//             colors: [_pieBlue, Color(0xFF0A2941)],
//             begin: Alignment.topLeft,
//             end: Alignment.bottomRight,
//           ),
//           borderRadius: BorderRadius.circular(22),
...
//           padding: const EdgeInsets.all(10),
//           decoration: BoxDecoration(
//             color: _pieGold.withOpacity(0.12),
//             borderRadius: BorderRadius.circular(16),
//           ),
//           child: Icon(
//             feature.icon,
...
//                 borderRadius: BorderRadius.circular(999),
//                 border: Border.all(
//                   color: _pieBlue.withOpacity(0.12),
//                 ),
//                 boxShadow: [
//                   BoxShadow(
//                     blurRadius: 8,
