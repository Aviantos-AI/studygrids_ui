...
// ✅ Converted to StatefulWidget for Mixin Support
class AgenticManagersDetailPage extends StatefulWidget {
  const AgenticManagersDetailPage({super.key});

  @override
  State<AgenticManagersDetailPage> createState() => _AgenticManagersDetailPageState();
}

// ✅ Added Mixin
class _AgenticManagersDetailPageState extends State<AgenticManagersDetailPage> with EnrollmentPopupMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ✅ Wrapped in Stack to support Sticky Bottom Bar
      body: Stack(
        children: [
          SingleChildScrollView(
            // ✅ Connected Mixin Scroll Controller
            ...
            child: Column(
              ...
              children: [
                ...
                // ✅ Extra padding for bottom bar space on mobile
        ...
        Wrap(
          ...
          children: [
            ElevatedButton(
              onPressed: () => _openEnrollmentDialog(context),
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFFFF7E21),
                foregroundColor: Colors.white,
                padding:
                    const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                shape: RoundedRectangleBorder(
